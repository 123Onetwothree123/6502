...
bool token::IsEndOfInput() const noexcept { return kind == Kind::EndOfInput; }
bool token::IsNumber() const noexcept { return kind == Kind::Number; }
bool token::IsRegister() const noexcept { return kind == Kind::Register; }
bool token::IsPlus() const noexcept { return kind == Kind::Plus; }
bool token::IsMinus() const noexcept { return kind == Kind::Minus; }
bool token::IsStar() const noexcept { return kind == Kind::Star; }
bool token::IsSlash() const noexcept { return kind == Kind::Slash; }
bool token::IsEqual() const noexcept { return kind == Kind::Equal; }
bool token::IsNotEqual() const noexcept { return kind == Kind::NotEqual; }
bool token::IsLessEqual() const noexcept { return kind == Kind::LessEqual; }
bool token::IsLogicalAnd() const noexcept { return kind == Kind::LogicalAnd; }
bool token::IsLeftParen() const noexcept { return kind == Kind::LeftParen; }
bool token::IsRightParen() const noexcept { return kind == Kind::RightParen; }
bool token::IsReadMemory8() const noexcept { return kind == Kind::ReadMemory8; }
...
bool token::IsUnaryOperator() const noexcept { return IsMinus() || IsStar(); }
bool token::IsOperator() const noexcept { return IsBinaryOperator() || IsUnaryOperator(); }
bool token::IsParenthesis() const noexcept { return IsLeftParen() || IsRightParen(); }
...
bool token::IsRightAssociative() const noexcept { return IsUnaryOperator(); }
std::string_view token::GetText() const noexcept { return text; }
std::uint32_t token::GetValue() const noexcept { return value; }
std::size_t token::GetPosition() const noexcept { return position; }
