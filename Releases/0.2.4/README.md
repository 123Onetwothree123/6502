...
- Current artifact build in this tree: `0.2.4X`
...
The current public `0.2.4` release is still comparatively generic
...
The current public release line is `0.2.4`. Full-content ReadyOS
profiles currently expose `18` launcher-visible apps, with
...
ReadyOS `0.2.4` is still explicitly experimental, but the purpose
