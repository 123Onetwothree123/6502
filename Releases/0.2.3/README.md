...
- Public release line: `0.2.3`
- Current artifact build in this tree: `0.2.3D`
...
The current public `0.2.3` release is still comparatively generic
...
The current public release line is `0.2.3`. Full-content ReadyOS
...
ReadyOS `0.2.3` is still explicitly experimental, but the purpose
