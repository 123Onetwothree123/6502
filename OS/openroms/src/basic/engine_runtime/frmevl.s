...
!ifndef HAS_OPCODES_65CE02 {
	...
	; Found the variable - emu6502 port: float variables need all the
...
FRMEVL_fetch_var_string:
	...
	; Copy string descriptor to FAC1
...
FRMEVL_fetch_float:
	...
	; emu6502 port: minimal integer-literal implementation (see emu6502_intmath.s)
...
FRMEVL_push_value_operator:
	...
	; emu6502 port: mirrors the string push below, operators pop type first
