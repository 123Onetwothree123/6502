;CP/M-65 BDOS Junior Computer II Version
;D. LAUSBERG	(C) 1988
;V1.0	21.01.88
...
;V2.3	11.06.22	BDOS0D corrected, RUBOUT added
;V2.4	06.11.23	BDOS R/W corrected
;V2.5	04.06.25	BDOS0A line input editor
;V2.6	23.12.25	error in BDOS0E corrected
...
.byt $00
DEFDRV:
.byt $00			;DEFAULT DRIVE

BLKBASE:
.dsb 3			;BLOCK/SECTOR TABLE

;========== Command TABLE AREA ========

BEFTAB:
.byt >BDOS00-1, <BDOS00-1 ;大端表项
	.byt >BDOS01-1, <BDOS01-1 ;大端表项
	.byt >BDOS02-1, <BDOS02-1 ;大端表项
	.byt >BDOS03-1, <BDOS03-1 ;大端表项
	.byt >BDOS04-1, <BDOS04-1 ;大端表项
	.byt >BDOS05-1, <BDOS05-1 ;大端表项
	.byt >BDOS06-1, <BDOS06-1 ;大端表项
	.byt >BDOS07-1, <BDOS07-1 ;大端表项
	.byt >BDOS08-1, <BDOS08-1 ;大端表项
	.byt >BDOS09-1, <BDOS09-1 ;大端表项
	.byt >BDOS0A-1, <BDOS0A-1 ;大端表项
	.byt >BDOS0B-1, <BDOS0B-1 ;大端表项
	.byt >BDOS0C-1, <BDOS0C-1 ;大端表项
	.byt >BDOS0D-1, <BDOS0D-1 ;大端表项
	.byt >BDOS0E-1, <BDOS0E-1 ;大端表项
	.byt >BDOS0F-1, <BDOS0F-1 ;大端表项
	.byt >BDOS10-1, <BDOS10-1 ;大端表项
	.byt >BDOS11-1, <BDOS11-1 ;大端表项
	.byt >BDOS12-1, <BDOS12-1 ;大端表项
	.byt >BDOS13-1, <BDOS13-1 ;大端表项
	.byt >BDOS14-1, <BDOS14-1 ;大端表项
	.byt >BDOS15-1, <BDOS15-1 ;大端表项
	.byt >BDOS16-1, <BDOS16-1 ;大端表项
	.byt >BDOS17-1, <BDOS17-1 ;大端表项
	.byt >BDOS18-1, <BDOS18-1 ;大端表项
	.byt >BDOS19-1, <BDOS19-1 ;大端表项
	.byt >BDOS1A-1, <BDOS1A-1 ;大端表项
	.byt >BDOS1B-1, <BDOS1B-1 ;大端表项
	.byt >BDOS1C-1, <BDOS1C-1 ;大端表项
	.byt >BDOS1D-1, <BDOS1D-1 ;大端表项
	.byt >BDOS1E-1, <BDOS1E-1 ;大端表项
	.byt >BDOS1F-1, <BDOS1F-1 ;大端表项
...
BDOS0A	LDY #0
	LDA (INBUFV),Y	;check for valid input string
	BMI BD0A0
	TAY
	LDA (INBUFV),Y	;last byte is EOT?
	BNE BD0A01
	DEY
	BEQ BD0A0
BD0A02	LDA (INBUFV),Y
	BMI BD0A01	;ASCII $20..$7F?
	CMP #$20
	BCC BD0A01
	DEY
	BNE BD0A02
	INY
	BNE BD0A1	;valid string detected

BD0A01	LDY #0		;reset string buffer
BD0A0	TYA
	STA (INBUFV),Y
	INY
	STA (INBUFV),Y
BD0A1	JSR CONIN	;get chr
	JSR TSTCHR
	BCS BD0A1
	CMP #$20	;is ist a control chr
	BCC BD0A2
	CMP #RUBOUT	;RUBOUT is BS
	BNE BD0A9
BD0A1A	LDA #<BS
	BNE BD0A4A	;do a BS

BD0A9	STA (INBUFV),Y	;put chr to line
BD0A9A	INY
	BMI BD0A3
BD0A8	JSR CONOUT	;print chr
	JMP BD0A1

BD0A3	DEY		;max. 126 chr
	BPL BD0A1
...
BD0A2	CMP #CR		;CR
	...
	JSR CONOUT
	LDA #0
	STA (INBUFV),Y	;set zero byte as EOT
	TYA
	LDY #0
	STA (INBUFV),Y	;set length byte
	RTS	
...
BDOS0D	LDA #0			;SELECT DEFAULT DRIVE
	...
	LDA DEFDRV
	JSR SELDRV		;DISK SELECT
	BCS BD0DX
	JSR HOME		;HOME DRIVE
	BCS BD0DX
	JSR SETVEC
	LDA DEFDRV		;return DEFDRV
	CLC
BD0DX	RTS


BDOS0E	PHA			;SET DEFAULT DRIVE
	JSR SELDRV		;select drive
	BCS BDOS0EX
	PLA
	STA DEFDRV		;store DEFAULT DRIVE if valid
	RTS

BDOS0EX	TAX			;save error code
	PLA
	TXA
	RTS


SELDRV	JSR SELDSK		;SELECT DRIVE
	BCS SELDRVX
...
BDOS14	JSR RWSET		;READ SEQUENTIAL
	BCS BD14A
	JSR RWINIT		;SET SECTOR
	JSR READ
	BCS BD14XX
BD14B	LDY #<FCB_RC		;PREPARE FOR NEXT BLOCK-R/W
	LDA (FCB1V),Y		;GET RC
	ADC #2			;RC=RC+2!
	STA (FCB1V),Y
	RTS
...
BDOS15	JSR RWSET		;WRITE SEQUENTIAL
	BCC BD15A
	CMP #EOEX
	BNE BD15D		;NO MORE EXTENSION
	LDA TEMP		;TEMP = ext nr
 	JSR NEWEXT		;OPEN NEW EXTENSION
	BCC BDOS15		;and continue writing
	RTS
...
TSTCH1	LDX #<CCODEX-CCODE	;Check control codes
TSTCH6	CMP CCODE,X
	BEQ TSTCHX
	DEX
	BPL TSTCH6
...
CCODE:
.byt CR,LF,BS,HT,CLS,CTRLA,CTRLS,CTRLD,CTRLF
CCODEX			;valid control chrs
...
RWSET	LDY #<FCB_RC 		;PREPARE FOR R/W-BLOCK
	LDA (FCB1V),Y		;GET RC
	CMP RPEXT		;end of extent?
	BCS RWSET4
	LDY #<FCB_REC
	CMP (FCB1V),Y		;RC >= LENGTH?
	BCS RWSET2
	lsr
	AND SPB 		;NEW BLOCK?
	BEQ RWSET1
...
RWSET1	JSR BLKOFS		;GET BLOCK OFFSET FOR FCB
	...
	CPX #0
	BEQ RWSET2
RWSET3	JSR SBTAB		;SET BLOCKTABLE
	RTS
...
RWSET4	LDA #%00000010		;set for new ext
...
RWSET5	LDY #<FCB_EXT
	...
	BCC RWSET1		;and set block table
RWSET7	CMP #NOTFND
	BNE RWSETX
	LDA #<EOEX
	SEC
