...
.byt ' Error $',EOT
RTYMES:
.byt CR,LF,'Retry	(Y/N) ? ',EOT

ETYPTB:
.byt 'BIOS',$00,'BDOS',$00,'CCP',$00,$00
	.byt 'RSX',$00,$00,'USER',$00

ERRTAB:
.byt $FE,$01,'CRC Error',EOT
	.byt $FD,$81,'Drive not ready',EOT
	.byt $FB,$81,'Sector not found',EOT
	.byt $F9,$01,'Invalid Drive',EOT
	.byt $DD,$82,'File not found',EOT
	.byt $D9,$02,'Invalid FCB',EOT
	.byt $C1,$04,'Syntax Error',EOT
	.byt $C0,$04,'No Command',EOT
