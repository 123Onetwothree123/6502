...
LIB_LAUNCHER = $(TUI_BASE_MENU_MISC) $(TUI_HOTKEY_SRC) $(REU_DMA_SRC) $(REU_CONTROL_BANK_SRC) $(REU_CONTROL_REGISTRY_SRC) $(RESUME_STATE_SEGMENT_SRCS)
...
LIB_REUVIEWER = $(TUI_BASE_NAV_MISC) $(TUI_HOTKEY_SRC) $(LIB_REU_DMA_STATS) $(REU_CONTROL_BANK_SRC) $(RESUME_STATE_SIMPLE_SRCS)
