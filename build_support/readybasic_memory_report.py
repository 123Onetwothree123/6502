...
def disk_module_blocks() -> list[Block]:
    # Mirrored from build_support/build_readybasic_disk_modules.py. Each proof
    # payload is the 23-byte int_command_payload() body generated by that helper.
    return [
        Block("RBM1 descriptor", 0x1500, 0x20, "desc", "ZDM1 descriptor copied by ZMODLD.", ("ZDM1",)),
        Block("RBM2 descriptors", 0x1600, 0x60, "desc", "Three descriptors copied by ZMODLD.", ("ZDM2S", "ZDOV1", "ZDOV2")),
        Block("RBM1 payload", 0x3000, 23, "module-a", "Module 3, submodule 1, slot 1.", ("ZDM1",)),
        Block("RBM2 span payload", 0x3200, 23, "module-b", "Module 4, submodule 2, slots 1+2.", ("ZDM2S",)),
        Block("RBM2 overlay 1", 0x3300, 23, "overlay", "Module 4, submodule 5, overlay 1, slot 2.", ("ZDOV1",)),
        Block("RBM2 overlay 2", 0x3400, 23, "overlay", "Module 4, submodule 5, overlay 2, slot 2.", ("ZDOV2",)),
    ]
