...
def main() -> None:
    ...
    require(r"^BASIC_START\s*=\s*\$2401\b", asm, "BASIC_START must be $2401")
    ...
    if resident[2] > 0x11FE:
        fail(f"RESIDENT grew past measured RET expression budget $11FE, got ${resident[2]:04X}")
