...
emit_type_step "demo_08_screen_reu_a" $'NEW\r10 DIM H%(4)\r20 FOR S=1 TO 4\r30 PRINT CHR$(147)\r40 GOSUB 1000\r50 H%(S)=SCRCAP()\r60 NEXT S\r70 PRINT CHR$(147);CHR$(158);"REU FLIPBOOK"\r80 PRINT "EXPECT: MAZE, CHECKER, PETSCII, STRIPES"\r90 PRINT CHR$(5);"EACH RESTORES SCREEN AND COLOR"\r100 FOR S=1 TO 4\r110 SCRPUT(H%(S))\r120 ZPAUSE(45)\r130 NEXT S\r140 PRINT CHR$(19);"RESTORED 4 REU SCREENS"\r150 END\r' "$READ_PAUSE"
emit_type_step "demo_08_screen_reu_b" $'1000 ON S GOSUB 1100,1200,1300,1400\r1010 RETURN\r1100 FOR R=0 TO 11:FOR C=0 TO 39\r1110 I=R*40+C:P=R*5+C*3\r1120 P=P-2*INT(P/2):K=R*3+C\r1130 K=K-8*INT(K/8)\r1140 POKE1024+I,47+P*45\r1150 POKE55296+I,1+K\r1160 NEXT C:NEXT R\r1170 PRINT CHR$(19);CHR$(158);"MAZE A  /\\/\\/\\/\\/\\/\\/":PRINT CHR$(5)\r1180 RETURN\r' "$READ_PAUSE"
emit_type_step "demo_08_screen_reu_c" $'1200 FOR R=0 TO 11:FOR C=0 TO 39\r1210 I=R*40+C:P=R+C\r1220 P=P-2*INT(P/2)\r1230 POKE1024+I,81+P*6\r1240 POKE55296+I,2+P*5\r1250 NEXT C:NEXT R\r1260 PRINT CHR$(19);CHR$(158);"CHECKER B  QWQWQWQW":PRINT CHR$(5)\r1270 RETURN\r1300 FOR I=0 TO 479\r1310 P=I-4*INT(I/4)\r1320 POKE1024+I,42+P*2\r1330 POKE55296+I,5+P*2\r1340 NEXT I\r1350 PRINT CHR$(19);CHR$(158);"PETSCII C  *+*+*+*+":PRINT CHR$(5)\r1360 RETURN\r' "$READ_PAUSE"
emit_type_step "demo_08_screen_reu_d" $'1400 FOR R=0 TO 11:FOR C=0 TO 39\r1410 I=R*40+C:P=R-4*INT(R/4)\r1420 K=R*2:K=K-16*INT(K/16)\r1430 POKE1024+I,1+P\r1440 POKE55296+I,1+K\r1450 NEXT C:NEXT R\r1460 PRINT CHR$(19);CHR$(158);"STRIPES D  AAA BBB CCC":PRINT CHR$(5)\r1470 RETURN\rPRINT CHR$(158);"EXPECT: FOUR DIFFERENT SCREENS FLIP BACK"\rPRINT CHR$(5)\rRUN\r' "$RUN_POST"
